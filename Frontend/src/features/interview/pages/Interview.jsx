...
export default function Interview({ report }) {
  const sample = {
    matchScore: 70,
    technicalQuestion: [
      {
    ...
    <div className="interview-page">
        ...
        <section className="center-content">
          {activeTab === 'technical' && (
            <div className="questions-block">
              <h3 className="block-title">⚙️ Technical Questions ({data.technicalQuestion?.length || 0})</h3>
              <div className="cards">
                {Array.isArray(data.technicalQuestion) && data.technicalQuestion.length > 0 ? (
          ...
          {activeTab === 'behavioral' && (
            <div className="questions-block">
              <h3 className="block-title">💬 Behavioral Questions ({data.behavioralQuestion?.length || 0})</h3>
              <div className="cards">
                {Array.isArray(data.behavioralQuestion) && data.behavioralQuestion.length > 0 ? (
          ...
          {activeTab === 'roadmap' && (
            <div className="roadmap-block">
              ...
              <div className="roadmap-cards">
                {Array.isArray(data.preparationPlan) && data.preparationPlan.length > 0 ? (
      ...
      <aside className="right-panel" aria-label="summary">
        <div className="score-widget">
          <div className="score-circle" style={{ ['--score']: data.matchScore }}>
        ...
        <div className="skill-gap">
          <h4>Skill Gaps</h4>
          {Array.isArray(data.skillGap) && data.skillGap.length > 0 ? (
